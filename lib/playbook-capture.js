...
const LOC = process.env.RUSHES_GHL_LOCATION_ID;
const TOKEN = process.env.RUSHES_GHL_PIT_TOKEN;
...
function requireConfig() {
  if (!TOKEN || !LOC) {
    throw new Error('Missing RUSHES_GHL_PIT_TOKEN or RUSHES_GHL_LOCATION_ID on server');
  }
}
...
module.exports = { capturePlaybookLead, validatePayload };
