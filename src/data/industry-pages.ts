...
export const industriesHub: IndustriesHub = {
  ...
  heading: 'Different businesses grow',
  emphasis: 'in different ways.',
  lede: 'These are a few industries where Rushes has relevant experience, not a limit on who we work with. The right strategy depends on the customer, the business model, the opportunity, and where better creative, reach, digital experience, AI, or business systems can create the most value.',
  primaryCta: 'Book a Growth Call',
  secondaryCta: 'Explore the examples',
  sharedPath: [
  ...
  faqs: [
    { question: 'Why these industries?', answer: 'They are useful examples of how Rushes adapts media, demand, digital experiences, AI, and business systems to different customers and decisions. They do not define the limits of who Rushes works with.' },
    ...
    { question: 'Do you work with businesses outside these industries?', answer: 'Yes. Rushes works across industries. The Growth Call looks at the goal, the opportunity, the investment required, and whether we can create enough value to justify the work.' },
    { question: 'Can I hire only one piece?', answer: 'Yes. Brand Media, campaigns, web, and AI or business systems can each stand alone. Rushes connects them only when the business goal genuinely benefits from it.' },
    { question: 'What happens on the Growth Call?', answer: 'In about 30 minutes, we look at what the business wants to improve, what already works, and which creative, growth, AI, or systems opportunity offers the clearest next move.' },
  ],
  ...
  bookingClose: {
    heading: 'Find the clearest way to create more value.',
    body: 'In 30 minutes, we’ll look at the business goal, what already works, and where stronger creative, more reach, a better customer experience, practical AI, or better systems could make the greatest difference.',
    bullets: ['The opportunity that matters now', 'What already works', 'The clearest practical next move'],
  },
};
...
export const industryPages: readonly IndustryPage[] = [
  {
    ...
    primaryCta: 'Book a Growth Call',
    secondaryCta: 'See the Demand Loop for this market',
    ...
    faqs: [
      ...
      { question: 'What if we are already booked months out?', answer: 'Then the priority may be project mix, next-season planning, or open-estimate continuity instead of more volume now. Rushes should not create demand the company cannot fulfill.' },
  ...
  },
  {
    ...
    systemSteps: [
      ...
      { name: 'Build editorial proof', body: 'Show the finished room, material decisions, constraints, process, and point of view instead of a disconnected gallery.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'Which services should we market?', answer: 'Start with one service, provider, device, or location where the practice has capacity, approved positioning, workable economics, and a clear consult path.' },
