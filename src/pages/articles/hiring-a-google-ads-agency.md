...
Clarify who will write and build the page, who approves its claims, and who repairs a broken form or booking link. Our [Web & Landing service](/web/) covers this part of the journey when the existing destination needs work.

The creative requirements depend on the campaign format. Search ad copy, display images and video assets have different jobs. Ask which formats are in scope and how the agency will decide whether new creative is worth producing. Original [brand photography and video](/brand-media/) can supply material for those placements, but production quality alone does not guarantee performance.
